...
def asterisk_pjsip_user_config(phonenum, username, userpass, pickupgroup):
...
def asterisk_sip_user_config(phonenum, username, userpass, pickupgroup):
    """generate sip user config for Asterisk"""
...
def yealink_phone_config(phonetype, phonehwmac, phonenum, username, userpass):
    ...
    for phone_prefix in phone_num_prefixes:
        ...
        for entry in connection.entries:
            ...
            if phone_type:
                ...
                log_debug(cfg_file_name)
                with open(tftp_dir + cfg_file_name, 'w') as f:
